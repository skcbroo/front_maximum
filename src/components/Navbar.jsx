...
export default function NavbarLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-white via-[#A6B8C7] to-[#222B3B] text-white">
      {/* Navbar */}
      <nav className="bg-gradient-to-r from-[#1E2A38] via-[#2D3C4F] to-[#222B3B] text-white shadow-md px-6 py-2 flex items-center justify-between select-none">
        ...
        <div className="flex items-center gap-2">
          <Link to="/">
            <img
              src="/logo2.png"
              alt="Logo"
              className="h-14 cursor-pointer drop-shadow-lg brightness-110 contrast-125"
              draggable="false"
            />
          </Link>
        </div>
