...
export default function NavbarLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-[#222B3B] via-[#A6B8C7] to-white text-white">
            {/* Navbar */}
            <nav className="bg-gradient-to-r from-[#222B3B] via-[#A6B8C7] to-white text-white shadow-md px-6 py-2 flex items-center justify-between select-none">
