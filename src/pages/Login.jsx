...
export default function Login() {
    ...
    <NavbarLayout>
      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-transparent px-4">
        <form
          ...
          className="w-full max-w-md bg-[#D5DADD] backdrop-blur-xl text-gray-800 rounded-2xl shadow-2xl border border-white/40 px-8 py-10"
  ...
  <button
    ...
    className={`w-1/2 p-3 rounded-lg text-white transition ${
      loading ? "bg-gray-500 cursor-not-allowed" : "bg-[#0AAFC0] hover:bg-[#9CC6CD]"
    }`}
  >
